...
function RegisterPage() {
  ...
  const isFormValid = () => {
    ...
    const isPasswordValid = form.password.length >= 6 && /[A-Z]/.test(form.password) && /[a-z]/.test(form.password) && /[0-9]/.test(form.password);
              ...
              <div>
                <div className="relative">
                  <input
                    ...
                    value={form.password}
                    onChange={handleChange}
                    className={`w-full border rounded-xl px-4 py-3 pr-12 transition-all duration-300 focus:outline-none focus:ring-2 ${passwordError ? "border-red-500 focus:ring-red-500 focus:border-red-500" : "border-slate-300 focus:ring-emerald-500 focus:border-emerald-500"}`}
                    required
